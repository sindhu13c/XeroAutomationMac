package com.testing.XeroAutomation;
...
public class ModuleXero extends ReUsableMethodsXero {
	...
	public static void loadProperty()
	{
		...
		{
			prop = new Properties();
			FileInputStream ip = new FileInputStream(System.getProperty("user.dir")+ "/src/test/java/com/testing/utility/config.properties");
			prop.load(ip);
		}
		catch(IOException e)
		{
	...
	public static void Lauch_Browser(String browser)
	{
		...
		{
			String driverPath="./src/test/java/com/testing/utility/geckodriver";
		...
		{
			String driverPath="./src/test/java/com/testing/utility/chromedriver";
